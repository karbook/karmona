    ...
    return (
        ...
        >
            <motion.section
                ...
                className="w-full max-w-[1580px] mx-auto px-4 sm:px-6 py-8 md:py-12 mb-10 scroll-mt-24">
            ...
            >
                <motion.section
                    id="contact"
                    className="flex flex-col gap-4 sm:gap-6 max-w-3xl w-full mx-auto px-4 py-8 sm:px-6 md:py-12 scroll-mt-25"
                    variants={cardVariants}
                >
                    <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-center mb-4 md:mb-6">
                        {t("Contact Us")}
